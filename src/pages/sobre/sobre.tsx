function Sobre() { 
  return ( 
      <> 
          <div className="w-full bg-[#F5F5F5] flex justify-center items-center py-4 min-h-screen"> {/* Adicionei min-h-screen */}
              <div className="max-w-7xl flex flex-col lg:flex-row items-center text-center lg:text-left gap-8"> 
                  <div className="flex flex-col items-center lg:items-start"> 
                      <h1 className="text-6xl font-instrument-sans font-semibold text-[#694873] mb-4">Sobre o Projeto</h1> 
